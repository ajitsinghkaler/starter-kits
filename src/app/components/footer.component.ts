    ...
    <footer class="relative py-20 flex flex-wrap container mx-auto max-w-3xl">
      <div class="w-full md:w-1/2 px-4">
        ...
        <div class="flex mt-10">
          <!-- <a
            ...
            aria-label="Facebook"
            href="https://www.facebook.com/profile.php?id=61553677897206"
            class=" ml-3 flex items-center space-x-3 hover:text-white hover:bg-black transition p-2 border rounded-full border-black"
          >
            <svg
          ...
          <a
            ...
            href="https://www.instagram.com/_chatterai/"
            class="ml-3 flex items-center space-x-3 hover:text-white hover:bg-black transition p-2 border rounded-full border-black      "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="w-1/2 md:w-1/4 px-4 mt-8 md:mt-0">
        <ul class="space-y-4">
          ...
          <li><a class="hover:underline" routerLink="/contact">Contact</a></li>
          <li><a class="hover:underline" routerLink="/submit">Submit</a></li>
        </ul>
      </div>
      <div class="w-1/2 md:w-1/4 px-4 mt-8 md:mt-0">
        <ul class="space-y-4">
